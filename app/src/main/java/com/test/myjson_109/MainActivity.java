...
import com.test.myjson_109.adapter.FilmAdapter;
import com.test.myjson_109.config.InitServices;
import com.test.myjson_109.config.UpdateDeleteListener;
import com.test.myjson_109.model.Film;
...
public class MainActivity extends AppCompatActivity implements UpdateDeleteListener {
    ...
    private void getFilm() {
        try{
            Call<GetFilm> call = InitServices.getInstance().getFilm();
        ...
        builder.setPositiveButton(
                ...
                new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        Call<PostPutDeleteFilm> call = InitServices.getInstance().delFilm(list_film.get(position).getId());
                        call.enqueue(new Callback<PostPutDeleteFilm>() {
                            @Override
                            public void onResponse(Call<PostPutDeleteFilm> call, Response<PostPutDeleteFilm> response) {
                            ...
                            @Override
                            public void onFailure(Call<PostPutDeleteFilm> call, Throwable t) {
